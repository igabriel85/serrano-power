...
/home/ubuntu/miniconda3/envs/pyml/bin/python sr_energy_experiments.py -f dnn.yaml -e dnn_exp_10 -cv 10
/home/ubuntu/miniconda3/envs/pyml/bin/python sr_energy_experiments.py -f cnn.yaml -e cnn_exp_10 -cv 10